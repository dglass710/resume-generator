...
class ResumeGeneratorGUI:
    ...
    def open_information_window(self):
        ...
        information_content = (
            ...
            "Features:\n\n"
            "1. Section Editors\n"
            "   - Each resume section has its own dedicated editor where you can add, edit, remove, and reorder items using intuitive controls.\n\n"
            "2. Reorder Sections\n"
            "   - Change the order of sections in your resume with a simple drag-and-drop interface, allowing you to prioritize different sections based on the job you're applying for.\n\n"
            "3. Selective Inclusion\n"
            "   - Use checkboxes and radio buttons to choose which sections and individual items appear on your resume, helping you build a focused document tailored to each job application.\n\n"
            "4. Harvard Resume Template\n"
            "   - Generate resumes that follow Harvard resume template guidelines with Times New Roman font, two-column format, and optimized spacing for a professional appearance.\n\n"
            "5. Custom Filename Output\n"
            "   - Specify your own custom filename when generating each resume, making it easy to stay organized.\n\n"
            "6. Flexible Education Entries\n"
            ...
            "7. Optimized Core Competencies Display\n"
            "   - Core Competencies are displayed as a comma-separated list that efficiently uses space rather than as bullet points.\n\n"
            "8. Easy Saving & Refreshing\n"
            ...
            "10. Browse Files\n"
            "    - Quickly access the folder where your resume files and JSON data are stored, making it easy to manage, back up, or share your files.\n\n"
            ...
            "13. Intuitive Controls\n"
            "    - Drag-and-drop functionality, Up/Down buttons, and context-sensitive editors make it easy to organize your resume content exactly how you want it.\n\n"
            "Cross-Platform Support:\n\n"
            "14. Multi-Platform Compatibility\n"
            "    - Designed to work on Windows, macOS, and Linux, with improved scrolling functionality for macOS users and helper scripts for Windows users.\n\n"
